...
<head>
	...
	<!-- Scripts -->
	@vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/css/themes/ui/main.css'])
</head>
	<body>
        ...
        <div class="row mt-5">
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="#"><img src="assets/img/shop_01.jpg" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="#"><img src="assets/img/shop_02.jpg" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="#"><img src="assets/img/shop_03.jpg" alt="" class="img-fluid"></a>
